...
class SarbacaneListsSync {
	...
	public function add_admin_menu() {
		add_submenu_page( 'sarbacane', __( 'Configuration', 'mailify' ), __( 'Configuration', 'mailify' ), 'administrator', 'wp_lists_sync', array(
			$this,
			'display_settings'
		) );
	}
	...
	public function display_settings() {
		...
		wp_enqueue_style ( 'sarbacane_lists_config.css', plugins_url ( 'css/sarbacane_lists_config.css', __FILE__ ), array(), '1.4.7' );
		wp_enqueue_script( 'sarbacane-lists-sync.js', plugins_url( 'js/sarbacane-lists-sync.js', __FILE__ ), array( 'jquery' ), '1.4.7' );
