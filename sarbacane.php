...
/*
Plugin Name: Mailify
Plugin URI: http://wordpress.org/plugins/mailify/
Description: This plugin allows you to synchronize your WordPress data in Mailify
Author: Sarbacane Software
Version: 1.4.7
Author URI: http://mailify.com/?utm_source=module-wordpress&utm_medium=plugin&utm_content=lien-sarbacane&utm_campaign=wordpress
Text Domain: mailify
Domain Path: /locales
*/
...
if ( defined( 'ABSPATH' ) ) {
	...
	define( 'SARBACANE__PLUGIN_DIRNAME', 'mailify' );
