...
<div id="sarbacane_desktop_content">
	<p class="<?php esc_attr_e( 'mailify', 'mailify' ) ?>_logo"></p>
	<!-- ========================================================================================== -->
	<!-- =====================================WIDGET SETUP========================================= -->
	<!-- ========================================================================================== -->
	<div id="sarbacane_desktop_widget">
		<form method="POST" action="" id="sarbacane_desktop_widget_form" autocomplete="off">
			...
			<div id="sarbacane_desktop_widget_field_<?php echo $i ?>">
				<div class="sarbacane_desktop_widget_summary">
					<label class="sarbacane_desktop_field_number"><?php echo __( 'Field', 'mailify' ) . ' ' . ( $i + 1 ) ?></label>
				...
				<p class="sarbacane_desktop_widget_configuration">
					<label class="sarbacane_desktop_inline_configuration_label " for="sarbacane_desktop_label_<?php echo $i ?>"><?php _e( 'Name', 'mailify' ) ?>&nbsp;:&nbsp;</label>
					<?php if ( $isEmail ) { ?>
					...
					<?php } ?>
					<label class="sarbacane_desktop_inline_configuration_label " for="sarbacane_desktop_field_<?php echo $i ?>"><?php _e( 'Placeholder', 'mailify' ) ?>&nbsp;:&nbsp;</label>
					...
					<br />
					<label class="sarbacane_desktop_inline_configuration_label " for="sarbacane_desktop_mandatory_<?php echo $i ?>"><?php _e( 'Mandatory', 'mailify' ) ?>&nbsp;:&nbsp;</label>
					...
					<label class="sarbacane_desktop_yes_no_label" for="sarbacane_desktop_mandatory_true_<?php echo $i ?>"><?php _e( 'Yes', 'mailify' ) ?></label>
					...
					<label class="sarbacane_desktop_yes_no_label" for="sarbacane_desktop_mandatory_false_<?php echo $i ?>"><?php _e( 'No', 'mailify' ) ?></label>
				</p>
				<p class="sarbacane_desktop_div_splitter"></p>
			</div>
			<?php 
			...
			<p><input type="button" class="sarbacane_desktop_configuration_button" value="<?php esc_attr_e( 'Add field', 'mailify' ) ?>" onclick="sarbacaneAddField()" id="sarbacane_desktop_add_field"/></p>
			...
			<label class="sarbacane_desktop_configuration_label" for="sarbacane_desktop_widget_registration_button"><?php _e( 'Button name', 'mailify' ) ?> :</label>
			<label class="sarbacane_desktop_inline_configuration_label" for="sarbacane_desktop_widget_registration_button"><?php _e( 'Name', 'mailify' ) ?> :</label>
			...
			<label class="sarbacane_desktop_configuration_label" for="sarbacane_desktop_widget_registration_mandatory_fields"><?php _e( 'Mandatory fields message', 'mailify' ) ?> :</label>
			<label class="sarbacane_desktop_inline_configuration_label" for="sarbacane_desktop_widget_registration_mandatory_fields"><?php _e( 'Name', 'mailify' ) ?> :</label>
			...
			<label class="sarbacane_desktop_configuration_label" for="sarbacane_desktop_widget_registration_message"><?php _e( 'Successful form submission message', 'mailify' ) ?> :</label>
		...
		<div id="sarbacane_desktop_configuration_footer">
			<input type="button" class="sarbacane_desktop_configuration_button sarbacane_desktop_configuration_button_green" value="<?php esc_attr_e( 'Save', 'mailify' ) ?>" onclick="sarbacaneSubmitForm()" />
		</div>
	</div>
	<!-- ========================================================================================== -->
	<!-- ===================================WIDGET PREVIEW========================================= -->
	...
	<div id="sarbacane_desktop_widget_info">
		...
		<p><?php _e( 'This tool allows you to create a form widget that you can add to WordPress', 'mailify' ) ?></p>
		<p><?php _e( 'The widget will sync subscribers with your Mailify contact list', 'mailify' ) ?></p>
		<p><?php _e( 'All data from the widget will be available in your list', 'mailify' ) ?></p>
		<p><?php _e( 'Any changes in the structure of the form will cause a refresh of the associated list in Mailify.', 'mailify' ) ?></p>
		<p class="sarbacane_desktop_div_splitter"></p>
		<div class="sarbacane_desktop_help_title">
			<?php _e( 'Need help ?', 'mailify' ) ?>
		</div>
		<p><?php _e( 'Email', 'mailify' ) ?> : <?php _e( 'help@mailify.com', 'mailify' ) ?><br /><?php _e( 'Phone', 'mailify' ) ?> : <?php _e( '(646)-844-0983', 'mailify' ) ?></p>
		<p><?php _e( 'For more informations, please take a look to our website', 'mailify' ) ?> :<br /> <a href="<?php _e( 'http://mailify.com/?utm_source=module-wordpress&utm_medium=plugin&utm_content=lien-sarbacane&utm_campaign=wordpress', 'mailify' ) ?>"><?php _e( 'http://www.mailify.com', 'mailify' ) ?></a></p>
	</div>
	<!-- ========================================================================================== -->
	<!-- =====================================FIELDS PATTERN======================================= -->
	<!-- ========================================================================================== -->
	<div style="display:none" id="fieldPattern">
		<div id="sarbacane_desktop_widget_field_FIELDNUMBER">
			<div class="sarbacane_desktop_widget_summary">
				<label class="sarbacane_desktop_field_number"><?php _e( 'Field', 'mailify' ) ?> PLUSONEFIELD </label>
				<ul class="sarbacane_widget_menu">
			...
			<p class="sarbacane_desktop_widget_configuration">
				<label class="sarbacane_desktop_inline_configuration_label " for="sarbacane_desktop_label_FIELDNUMBER"><?php _e( 'Name', 'mailify' ) ?> :</label>
				...
				<label class="sarbacane_desktop_inline_configuration_label " for="sarbacane_desktop_field_FIELDNUMBER"><?php _e( 'Placeholder', 'mailify' ) ?> :</label>
				...
				<label class="sarbacane_desktop_inline_configuration_label " for="sarbacane_desktop_mandatory_FIELDNUMBER"><?php _e( 'Mandatory', 'mailify' ) ?> :</label>
				...
				<label class="sarbacane_desktop_yes_no_label" for="sarbacane_desktop_mandatory_true_FIELDNUMBER"><?php _e( 'Yes', 'mailify' ) ?></label>
				...
				<label class="sarbacane_desktop_yes_no_label" for="sarbacane_desktop_mandatory_false_FIELDNUMBER"><?php _e( 'No', 'mailify' ) ?></label>
			</p>
			<p class="sarbacane_desktop_div_splitter"></p>
		</div>
	</div>
